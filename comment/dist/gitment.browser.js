...
var NOT_INITIALIZED_ERROR = exports.NOT_INITIALIZED_ERROR = new Error('Comment Not Initialized');
...
function renderHeader(_ref, instance) {
  ...
  issueLink.innerText = 'Turn to Issue';
...
function renderFooter() {
  ...
  container.innerHTML = '\n	works for\n	<a class="gitment-footer-project-link" href="https://github.com/nanqinlang" target="_blank">\n	  nanqinlang\n	</a>\n  ';
  return container;
}
...
var Gitment = function () {
  ...
  function Gitment() {
	...
	Object.assign(this, {
	  ...
	  oauth: {},
	  perPage: 6,	//每页的留言数
	  maxCommentHeight: 300	//最大的留言区的高度
	}, options);
	...
	if (query.code) {
	  ...
	  _utils.http.post('https://sometimesnaive.org/oauth/', {
		code: code,
		client_id: client_id,
